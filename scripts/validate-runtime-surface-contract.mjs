...
const TUI_ENTRYPOINT_ANCHORS = new Map([
  ...
  [
    ...
    /fn interrupt_current|fn pause_current_goal|fn request_background_current|fn shutdown/,
  ],
  ["provider_suspension.poll", /RuntimeProviderSuspensionControl/],
  ["run_hosted_operation", /fn run_hosted_operation|with_generation_handlers|start_turn_with_config/],
  ["hosted_event_observer", /fn finish_foreground|impl EventObserver/],
  ["approval_handler", /fn resolve_interactive/],
  ["permission_handler", /fn request_permissions/],
  ["user_input_handler", /fn request_user_input/],
  ["mcp_elicitation_handler", /fn request_mcp_elicitation|impl McpElicitationHandler/],
...
const BASELINE_DIRECT_TUI_MUTATION_SITES = new Map([
  ...
  ["crates/orca-tui/src/operation_controller.rs:pause_current_goal:interaction_broker.mutate", 1],
  ["crates/orca-tui/src/operation_controller.rs:install_hosted:interaction_broker.mutate", 3],
  ["crates/orca-tui/src/operation_controller.rs:complete_hosted:interaction_broker.mutate", 1],
  ["crates/orca-tui/src/operation_controller.rs:register_interaction:interaction_broker.mutate", 1],
  ...
  ["crates/orca-tui/src/runtime_interaction_adapter.rs:request_permissions:interaction_projection.mutate", 4],
...
const BASELINE_HARMLESS_SAME_NAME_FUNCTION_SHA256 = new Map([
  ...
  ["crates/orca-tui/src/operation_controller.rs:shutdown", "2710286ea9bb4dcaff490ed4534b65fbc961ab6811f399ae2ff3cd39195fbd27"],
...
const BASELINE_HARMLESS_ASSOCIATED_FUNCTION_SHA256 = new Map([
  ...
  [
    ...
    "0e911898ea3d74094304063412055c9e1533f3eea1a88c59e5250d27773fd091",
  ],
]);

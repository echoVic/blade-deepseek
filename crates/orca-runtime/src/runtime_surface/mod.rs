...
pub use identity::{
    ...
    CursorSourceRevision, Denied, DisplayText, DurableRevision, DurationMillis, FiniteF64,
    GoalCatalogRevision, GoalObjectiveRevision, GoalOwnerEpoch, GoalRevision, HostIncarnation,
    HostLifecycleRevision, HostMonotonicClockId, HostRevisionWitness, InputCatalogRevision,
    InteractionRevision, LiveRevision, McpCatalogRevision, MemoryRevision, MonotonicInstant,
    MonotonicTick, NonEmptySet, NonEmptyText, NonEmptyVec, OpaqueToken, OptionalProcessLocalCancel,
    PinnedContextRevision, PinnedContextSourceRevision, PinnedFileRevision, PinnedSystemRevision,
    PinnedUserRevision, PlanRevision, PolicyEpoch, PolicyOwnerLease, ProcessLeaseWitness,
    ProjectRootMemoryRevision, ResponseRouteEpoch, Revision, Rfc3339Timestamp,
    SAFE_DIAGNOSTIC_TEXT_BYTE_LIMIT, SafeDiagnosticText, SequenceNumber, SessionCatalogRevision,
    SessionHealthRevision, SessionMetadataRevision, Set, SettingsRevision, Sha256Digest,
    SubagentRevision, SurfaceAdmissionLeaseId, SurfaceAttachmentGrant, SurfaceAttachmentId,
    SurfaceAttachmentRole, SurfaceBackgroundFence, SurfaceBackgroundOwnerToken, SurfaceBoundCaller,
    SurfaceCapability, SurfaceCapabilityCallId, SurfaceCatalogEntryId, SurfaceCommitId,
    SurfaceConnectionId, SurfaceCursor, SurfaceEventId, SurfaceFinalizeIntentId,
    SurfaceGenerationId, SurfaceGoalFence, SurfaceGoalId, SurfaceGoalIntentId,
    SurfaceGoalOuterTurnId, SurfaceGoalRunId, SurfaceHostBoundCaller, SurfaceIncarnation,
    SurfaceInputCorrelationId, SurfaceInteractionId, SurfaceItemId, SurfaceOperationFence,
    SurfaceOperationId, SurfacePublisherPermit, SurfacePublisherPermitId, SurfaceRemoteTerminalId,
...
pub use operation::{
    ...
    SurfaceGoalGenerationIdentity, SurfaceInput, SurfaceInputBinding, SurfaceInputBindingKind,
    SurfaceInputBindingRequest, SurfaceInputBlock, SurfaceInputPresentation, SurfaceInputRequest,
    SurfaceInputRequestBlock, SurfaceInternalOriginPermit, SurfaceLegacyMentionKind,
    SurfaceLegacyMentionTarget, SurfaceLegacyPath, SurfaceLegacyUri, SurfaceNetworkDomainAccess,
...
pub use projection::{
    ...
    RunningSurfaceSubagent, SessionPatch, SettingsPatch, SubagentPatch,
    ...
    SurfaceCapabilityCallState, SurfaceCompletedModelResponse, SurfaceContextFragment,
    ...
    SurfaceMcpResourceTemplate, SurfaceMcpServerStatus, SurfaceMcpTool, SurfacePinnedContextEntry,
    ...
    SurfaceRemoteTerminalLeaseState, SurfaceSessionHealth, SurfaceSettingsSnapshot,
    SurfaceSubagent, SurfaceSubagentStatus, SurfaceSubagentTerminalStatus, SurfaceTask,
    SurfaceTaskStatus, SurfaceTaskType, SurfaceTerminalExitStatus, SurfaceThreadSnapshot,
    SurfaceToolResult, SurfaceToolResultKind, SurfaceToolTerminal, SurfaceToolView,

...
pub mod surface {
    pub use crate::runtime_surface::{
        ...
        InteractionPatch, MutationReply, NonEmptyText, NonEmptyVec, OperationIngressCorrelation,
        OperationKind, OperationPatch, OperationRequestIntent, OperationSettingsPreparation,
        OperationTerminal, PermissionGrantScope, ProviderReplayHealth, ReplayabilityRequest,
        RuntimeSettingsPatch, RuntimeSurfaceClientHandle, RuntimeSurfaceHandle,
        RuntimeSurfaceHostHandle, RuntimeSurfaceThreadHandle, SequenceNumber, Set, Sha256Digest,
        SnapshotAtCursor, SurfaceAllowDeny, SurfaceApprovalMode, SurfaceAssistantStream,
        ...
        SurfaceContextSnapshot, SurfaceCursor, SurfaceEvent, SurfaceEventEnvelope, SurfaceEventId,
        SurfaceFileChange, SurfaceIncarnation, SurfaceInputRequest, SurfaceInputRequestBlock,
        ...
        SurfacePlanStatus, SurfaceReasoningEffort, SurfaceRequestId, SurfaceScope,
        ...
        SurfaceThreadId, SurfaceToolResultKind, SurfaceUserInputDecision, ThreadOwnerEpoch,
        ToolPatch, WaitOperationTerminalResult,
    };
}

...
pub mod surface {
    pub use crate::runtime_surface::{
        ...
        RuntimeSurfaceClientHandle, RuntimeSurfaceHandle, SequenceNumber, Set, Sha256Digest,
        SnapshotAtCursor, SurfaceApprovalMode, SurfaceAssistantStream, SurfaceAssistantStreamState,
        ...
        SurfaceSubscriptionReceiver, SurfaceThreadId, SurfaceToolResultKind, ThreadOwnerEpoch,

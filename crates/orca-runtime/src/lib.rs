...
pub mod surface {
    pub use crate::runtime_surface::{
        ...
        OperationTerminal, PermissionGrantScope, PinnedContextAction, PinnedContextMutationOutput,
        PinnedContextPatch, PinnedContextRevision, PinnedContextSourceRevision, PinnedUserRevision,
        ...
        SurfaceInteractionKind, SurfaceInteractionRequest, SurfaceInteractionView,
        ...
        SurfaceSubscriptionReceiver, SurfaceThreadId, SurfaceToolResultKind,
        SurfaceUserInputDecision, ThreadOwnerEpoch, ToolPatch, WaitOperationTerminalResult,
    };
}

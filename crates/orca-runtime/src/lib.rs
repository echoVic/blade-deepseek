...
pub mod surface {
    pub use crate::runtime_surface::{
        ...
        RuntimeSurfaceThreadHandle, SequenceNumber, Set, Sha256Digest, SnapshotAtCursor,
        SurfaceAllowDeny, SurfaceApprovalMode, SurfaceAssistantStream, SurfaceAssistantStreamState,
        SurfaceAttachmentRole, SurfaceCapability, SurfaceCatalogEntryId, SurfaceClientCommandError,
        ...
        SurfaceFileChange, SurfaceGoal, SurfaceGoalFence, SurfaceGoalPauseReason,
        SurfaceGoalReceiptState, SurfaceGoalState, SurfaceHistoryAssistantRole, SurfaceHistoryId,
        SurfaceHistoryMessage, SurfaceHistorySystemRole, SurfaceHistoryToolRole,
        SurfaceHistoryUserRole, SurfaceIncarnation, SurfaceInput, SurfaceInputBlock,
        ...
        SurfaceInteractionRequest, SurfaceInteractionView, SurfaceItem, SurfaceItemId,
        SurfaceItemOrigin, SurfaceMcpElicitationDecision, SurfaceMcpElicitationRequest,
        SurfaceOperationFence, SurfaceOperationId, SurfacePermissionClientDecision,
        SurfacePermissionProfile, SurfacePinnedContextEntry, SurfacePinnedContextKind,
        SurfacePlanStatus, SurfaceReasoningEffort, SurfaceRecoverableOperation, SurfaceReduceMode,
...
mod tests {
    ...
    fn runtime_special_dispatch_is_owned_by_runtime_special_module() {
        ...
        for marker in [
            ...
            "execute_request_permissions_tool_with_policy",
    ...
    fn runtime_bash_internal_execution_uses_grouped_contexts() {
        ...
        for marker in [
            ...
            "RuntimeBashPermissionPolicy::network_block_prompt(",
            "RuntimeBashPermissionPolicy::filesystem_write_prompt(",
            "RuntimeBashPermissionPolicy::unsandboxed_shell_prompt(",
        ] {
            assert!(

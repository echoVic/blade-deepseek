...
pub mod surface {
    pub use crate::runtime_surface::{
        ...
        SurfaceInput, SurfaceInputBlock, SurfaceInputCorrelationId, SurfaceInputPresentation,
        SurfaceInputRequest, SurfaceInputRequestBlock, SurfaceInteractionId,
        SurfaceInteractionKind, SurfaceInteractionRequest, SurfaceInteractionView, SurfaceItem,
        ...
        SurfacePlanStatus, SurfaceReasoningEffort, SurfaceRequestId, SurfaceResolvedInputFact,

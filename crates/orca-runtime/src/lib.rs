...
pub mod surface {
    pub use crate::runtime_surface::{
        ...
        FailureClass, FreshAttachRequest, FreshSurfaceAttachment, MutationReply, NonEmptyVec,
        OperationIngressCorrelation, OperationKind, OperationPatch, OperationRequestIntent,
        OperationSettingsPreparation, OperationTerminal, ProviderReplayHealth,
        ReplayabilityRequest, RuntimeSurfaceClientHandle, RuntimeSurfaceHandle, SequenceNumber,
        Set, Sha256Digest, SnapshotAtCursor, SurfaceAssistantStream, SurfaceAssistantStreamState,
        ...
        SurfaceInteractionKind, SurfaceOperationId, SurfacePlanStatus, SurfaceRequestId,
        SurfaceScope, SurfaceShutdownReason, SurfaceSnapshot, SurfaceStreamId,

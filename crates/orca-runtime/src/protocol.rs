...
struct WireParams {
    ...
    #[serde(default)]
    decision: Option<PermissionResponseDecision>,
    #[serde(default)]
    ...
    #[serde(default)]
    model: Option<CwdOrModelFilter>,
    #[serde(default)]
    cwd: Option<CwdOrModelFilter>,
    #[serde(default)]
    env: Option<CommandEnvOverrides>,
    ...
    #[serde(default)]
    command: Option<WireCommandParam>,
...
fn command_text_from_wire(command: Option<&WireCommandParam>) -> Option<String> {
    match command? {
...
fn command_args_from_wire(command: Option<&WireCommandParam>) -> Option<Vec<String>> {
    match command? {
...
fn command_cwd_from_wire(cwd: Option<&CwdOrModelFilter>) -> Option<PathBuf> {
    match cwd {
...
fn command_exec_options_from_params(params: &WireParams) -> CommandExecOptions {
    CommandExecOptions {
...
fn command_sandbox_policy_from_wire(value: Option<&Value>) -> CommandSandboxPolicy {
...
fn network_access_from_wire(value: Option<&Value>) -> NetworkAccess {
...
fn shell_terminal_mode_from_params(params: &WireParams) -> ShellTerminalMode {
...
fn parse_sort_direction_desc_default(params: &WireParams) -> SortDirection {
...
fn parse_sort_direction_asc_default(params: &WireParams) -> SortDirection {
    match params.sort_direction.as_deref() {
...
fn parse_thread_sort_key(params: &WireParams) -> ThreadSortKey {
...
fn parse_thread_list_filters(params: &WireParams) -> ThreadListFilters {
    ThreadListFilters {
...
fn parse_items_view(params: &WireParams) -> TurnItemsView {
...
fn prompt_from_turn_start_params(params: Option<WireParams>) -> String {
    params
        .map(|params| {

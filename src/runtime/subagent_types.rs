...
impl SubagentType {
    ...
    pub fn allowed_tools(&self) -> Vec<&'static str> {
        match self {
            ...
            Self::TestWriter => vec!["read_file", "list_files", "grep", "bash", "edit"],
            Self::Debugger => vec!["read_file", "list_files", "grep", "bash"],
            Self::Documenter => vec!["read_file", "list_files", "grep", "edit"],
            Self::Custom(_) => vec![
                "read_file",
                "list_files",
                "grep",

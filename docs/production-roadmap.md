...
4. Prepare for long-running shell sessions, worktree automation, and async
   ...
   takes a grouped `RuntimeNormalToolTurnContext` in v0.1.112. The feature work
   remains open after v0.1.112 for deeper shell/session and async-subagent
   convergence.

...
4. Prepare for long-running shell sessions, worktree automation, and async
   ...
   `runtime_turn_iteration` in v0.1.117, and runtime turn-opening orchestration moved into
   `runtime_turn_opening` in v0.1.118, and runtime turn-start orchestration
   moved into `runtime_turn_start` in v0.1.119. The feature work remains open after v0.1.119 for deeper

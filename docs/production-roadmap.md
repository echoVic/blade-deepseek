...
4. Prepare for long-running shell sessions, worktree automation, and async
   ...
   bash in v0.1.114. The feature work remains open after v0.1.114 for deeper
   shell/session and async-subagent convergence.

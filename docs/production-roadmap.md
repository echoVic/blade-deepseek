...
4. **Permission profile persistence:** Codex preserves approval mode across
   ...
   silently treated as literal paths. Fully restricted Codex read allow-list
   enforcement, `:minimal`, glob expansion/enforcement, and real network

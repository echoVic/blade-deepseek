...
4. Prepare for long-running shell sessions, worktree automation, and async
   ...
   `runtime_turn_opening` in v0.1.118. The feature work remains open after v0.1.118 for deeper

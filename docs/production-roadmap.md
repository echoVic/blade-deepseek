...
4. Prepare for long-running shell sessions, worktree automation, and async
   ...
   `runtime_turn_iteration` in v0.1.117. The feature work remains open after v0.1.117 for deeper

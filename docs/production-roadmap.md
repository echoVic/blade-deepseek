...
4. Prepare for long-running shell sessions, worktree automation, and async
   ...
   v0.1.106; tool-call argument progress landed in v0.1.107, and lifecycle-to-normal-tool invocation now funnels through a single runtime_normal_tool helper in v0.1.108. The feature work remains open after v0.1.108.

...
the long roots/cancel method directly.
...
4. Prepare for long-running shell sessions, worktree automation, and async
   ...
   runtime_normal_tool helper in v0.1.108, and router-to-lifecycle normal-tool
   routing now uses a grouped `RuntimeNormalToolInvocation` in v0.1.109. The
   feature work remains open after v0.1.109.

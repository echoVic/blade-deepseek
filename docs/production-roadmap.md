...
4. Prepare for long-running shell sessions, worktree automation, and async
   ...
   `ToolApprovalGateContext` in v0.1.111. The feature work remains open after
   v0.1.111.

...
4. Prepare for long-running shell sessions, worktree automation, and async
   ...
   `RuntimeBashInvocationContext` in v0.1.115. The feature work remains open
   after v0.1.115 for deeper shell/session and async-subagent convergence.

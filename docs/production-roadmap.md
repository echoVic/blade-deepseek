...
4. Prepare for long-running shell sessions, worktree automation, and async
   ...
   moved into `runtime_turn_start` in v0.1.119, and runtime model-route
   orchestration moved into `runtime_model_route` in v0.1.120. The feature work remains open after v0.1.120 for deeper

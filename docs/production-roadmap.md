...
4. Prepare for long-running shell sessions, worktree automation, and async
   ...
   orchestration moved into `runtime_model_route` after v0.1.119. The feature work remains open after v0.1.119 for deeper

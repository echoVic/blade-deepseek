...
4. Prepare for long-running shell sessions, worktree automation, and async
   ...
   v0.1.123, and runtime lifecycle state machine types moved into
   `runtime_lifecycle` in v0.1.124. The feature work remains open after
   v0.1.124 for deeper shell/session, async-subagent, and reducer-style runtime
   convergence.

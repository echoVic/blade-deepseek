...
4. Prepare for long-running shell sessions, worktree automation, and async
   ...
   orchestration moved into `runtime_model_route` in v0.1.120, and runtime
   steer application moved into `runtime_steer` after v0.1.120. The feature
   work remains open after v0.1.120 for deeper

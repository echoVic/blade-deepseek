...
4. Prepare for long-running shell sessions, worktree automation, and async
   ...
   `runtime_lifecycle` in v0.1.124, and `RuntimeToolActorContext` moved into
   `runtime_tool_actor` in v0.1.125. The feature work remains open after
   v0.1.125 for deeper shell/session, async-subagent, and reducer-style runtime
   convergence.

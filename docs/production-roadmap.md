...
4. Prepare for long-running shell sessions, worktree automation, and async
   ...
   `complete_projected_tool_item` helper in v0.1.110. The feature work remains
   open after v0.1.110.

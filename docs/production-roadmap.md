...
4. Prepare for long-running shell sessions, worktree automation, and async
   ...
   boundary landed in v0.1.105; the feature work remains open after v0.1.105.

...
| MCP | stdio/SSE config surface, tool routing, and read-only resource list/read tools | Codex MCP client/server ecosystem | Partial; resource access seeded |

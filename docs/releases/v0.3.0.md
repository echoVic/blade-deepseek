...
- PowerShell 7, Windows PowerShell, cmd.exe, and explicit Git Bash commands are
  resolved with their own quoting and invocation rules. ConPTY backs
  interactive shell sessions, including terminal resize and process-tree
  cleanup through Job Objects.
